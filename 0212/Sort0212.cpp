//
// Created by Insomnia on 19-2-12.
// MIT License
//
#include <iostream>
#include <vector>
...
int main() {
    vector<int> vec1 = randomVec(10, 100);
    Solution sol;
    //sol.quickSort(vec1, 0, vec1.size() - 1);
    //out(vec1);
    vector<int> vec2 = randomVec(10, 100);
    sol.mergeSort(vec2, 0, vec2.size() - 1);
    out(vec2);
